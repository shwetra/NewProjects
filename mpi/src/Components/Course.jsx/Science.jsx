...
export const Science = () => {
  return (
    <Box mt="20px" bg="#D7B369" fontWeight={600} pt="40px" pb="20px">
        <Heading color="#102A83" pb="50px">Department of Science</Heading>
        <SimpleGrid columns={[1,2,2]} w="90%" m="auto" gap="20px" >

<Box w={{base:"300",lg:"370px"}}  pt="50px" pb="50px" bg={"white"} borderRadius={"15px"}>
<Heading
              as="h3"
              w="100%"
